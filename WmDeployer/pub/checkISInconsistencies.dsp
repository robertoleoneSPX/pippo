...
<TABLE class="tableView">
  ...
  <TR>
	...
	<FORM id="form" name="form" method="POST" action="target-groupsIS.dsp" target="treeFrame">
...
<script>
			...
			var devTree1 = new WebFXTree("List Of Servers");
			...
			var matchCnt1 = 0;
					...
					%invoke wm.deployer.gui.UITargetGroup:findErroneousServerInISTargetGroup%
					...
					%endinvoke findErroneousServerInISTargetGroup%

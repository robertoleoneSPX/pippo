...
if(is_csrf_guard_enabled && needToInsertToken) {
   srcLeftFrame="varsub-servers.dsp?projectName=%value projectName%&pluginType=%value pluginType%&action=%value action%&mapSetName=%value mapSetName%"+ '&' + _csrfTokenNm_ + "=" + _csrfTokenVal_;
   srcPropertyFrame="blank.html";   
} 
else {
   srcLeftFrame="varsub-servers.dsp?projectName=%value projectName%&pluginType=%value pluginType%&action=%value action%&mapSetName=%value mapSetName%";
   srcPropertyFrame="blank.html";
}

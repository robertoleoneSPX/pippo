...
<TR class="subheading2">
	...
	<TD width="25%" align="middle" id="releasex" onclick="onPressReleasex()"> 
		<A ID="release-list" class="imagelink" target="body" href="release.dsp?projectName=%value -htmlcode projectName%">
	...
	<TD width="25%" align="middle" id="mapx" onclick="onPressMapx()">
		<A ID="map-list" class="imagelink" target="body" href="mapset.dsp?projectName=%value -htmlcode projectName%">
	...
	<TD width="25%" align="middle" id="deployx" onclick="onPressDeployx()">
		<A ID="deploy-list" class="imagelink" target="body" href="deploy.dsp?projectName=%value -htmlcode projectName%">

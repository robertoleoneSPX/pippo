...
<TABLE width="100%">
  <TR>
    <TD colspan="2">
      <UL>
				<LI> <A onclick="return startProgressBar('Refreshing webMethods Files');" href="define-webm-branch.dsp?projectName=%value projectName%&bundleName=%value bundleName%&serverAliasName=%value serverAliasName%&topDir=%value topDir%&regExp=%value regExp%">Refresh this Page</A></LI> 
       </UL>
    </TD>
  </TR>
</TABLE>
...
%endcomment%
	<FORM id="form" name="form" method="POST" action="define-webm-branch.dsp">
...
%ifvar parentTopDir -notempty%
		"define-webm-branch.dsp?projectName=%value /projectName%&bundleName=%value /bundleName%&serverAliasName=%value ../serverAliasName%&topDir=%value parentTopDir -urlencode%&regExp=%value /regExp%", 
%else%
		"define-webm-files.dsp?projectName=%value /projectName%&bundleName=%value /bundleName%&regExp=%value /regExp%", 
%endif%

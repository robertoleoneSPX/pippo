...
if(is_csrf_guard_enabled && needToInsertToken) {
   src="deploy-list.dsp?projectName=%value projectName%&projectType=%value projectType%&" + _csrfTokenNm_ + "=" + _csrfTokenVal_;
} else {
   src="deploy-list.dsp?projectName=%value projectName%&projectType=%value projectType%";
}
